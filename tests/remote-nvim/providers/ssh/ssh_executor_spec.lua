...
describe("SSH Executor", function()
  ...
  describe("should correctly handle prompt", function()
    ...
    before_each(function()
      executor:reset()
      ui_input_stub = stub(vim.ui, "input")
      ui_input_stub.invokes(function(opts, callback)
        callback("test")
      end)
      chan_send:clear()
    end)
    ...
    it("of static type", function()
      ...
      assert.stub(ui_input_stub).was.called_with({ prompt = prompts[1].input_prompt }, match.is_function())
    ...
    it("of type dynamic", function()
      ...
      assert.stub(ui_input_stub).was.called_with({ prompt = prompts[2].input_prompt }, match.is_function())
